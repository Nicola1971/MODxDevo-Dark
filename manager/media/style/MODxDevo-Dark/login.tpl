...
<head>
	...
	font-family:proxima-nova,sans-serif; !important; /* IE ignores this and renders Arial better */
	font-family: Arial, Tahoma, Helvetica, sans-serif;height: 100%;color: #fff;}
    body {font-size: 75%; /* 12px 62.5% for 10px*/margin-bottom: 1px; /* avoid jumping scrollbars */background: #323232;}
...
padding:8px 0 8px 20px; 
   ...
   .sectionHeaderLogin a,.sectionHeaderLogin a:active,.sectionHeaderLogin a:visited,.sectionHeaderLogin a:link {color: #499bea;text-decoration: none;}
    .sectionBody {padding: 2px 20px 20px;display: block; background: transparent;
	    height: auto !important; 
    height: 270px;     
    min-height: 270px;
}
    #mx_loginbox {background:#535353; width: 460px;margin: 30px auto 0; border:1px solid #3c3f41; 
border-top:1px solid #919191; -webkit-border-radius: 3px;
...
border-radius: 3px; }
    ...
    input.text {color:#FFF; width: 400px;background: #434343;border:1px solid #282828;padding:6px; 
-ms-border-radius:3px;
	-o-border-radius:3px;
	border-radius:3px;}	
	input.text:focus {
border:solid 1px #499bea;
-webkit-box-shadow:#499bea 0 0 7px;
-moz-box-shadow:#499bea 0 0 7px;
box-shadow:#499bea 0 0 7px;}
...
border-radius:3px;;}
	input.login:hover {
background: linear-gradient(to bottom,  #207ce5 0%,#499bea 100%)!important;
	...
	a#ForgotManagerPassword-show_form {color:#FFF;}
    img#logo {
	padding: 8px 4px 0 0;
}
    </style>
...
<div id="mx_loginbox">
    ...
    [+OnManagerLoginFormPrerender+]
        <div class="sectionHeaderLogin"><img src="media/style/[+theme+]/images/misc/modx-logo-header.png" alt="[+site_name+]" id="logo" /><a href="../">[+site_name+]</a></div>
